...
async function main() {
  console.log(kleur.cyan('Starting the build process...'));
  try {
    console.log(kleur.blue('Running the Jekyll build...'));
    await execa('npm', ['run', 'jekyll:build'], { stdio: 'inherit' });
    console.log(kleur.green('Jekyll build complete'));
