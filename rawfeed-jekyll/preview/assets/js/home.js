document.addEventListener("DOMContentLoaded", () => {
  ...
  if (terminal) {
    ...
    const commands = {
      ...
      help: `about ------------- A brief summary about 'rawfeed'
...
`,
      ...
      socials: socialsEl ? socialsEl.innerHTML : "No socials found"
    };
    ...
    const createInputLine = () => {
      ...
      prompt.textContent = "[rawfeed@linux ~]#";
    ...
    const processCommand = (cmd) => {
      ...
      //   commandsPrint(cmd.split(" ").slice(1).join(" "))
        ...
        commandsPrint(cmd + `: command not found.`, "text");
      }
    };
...
`;
    ...
    const socialsWriteHTML = (content, mode = "html") => {
      ...
      socialsCommandDesc.textContent = `Click on a link and go directly to my social network:
`;
